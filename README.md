...
You have to design & build the backend for the application and the ability for the users to register, search and install apps.
...
https://github.com/azaylamba/playstore 
